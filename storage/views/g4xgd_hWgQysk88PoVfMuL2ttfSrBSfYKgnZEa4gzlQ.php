...
// PUG_DEBUG:38
 ?>    <form<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](['action' => '/users/password/change'], ['method' => 'POST'], array(  ))) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:15
 ?>        <div<?= (is_bool($_pug_temp = $pugModule['Phug\Formatter\Format\BasicFormat::attributes_assignment'](['class' => 'alert-success mb-4'], array(  ))) ? var_export($_pug_temp, true) : $_pug_temp) ?>>
<?php 
...
// PUG_DEBUG:13
 ?><?= htmlspecialchars((string) ((is_bool($_pug_temp = (isset($success) ? $success : null)) ? var_export($_pug_temp, true) : $_pug_temp))) ?></p>
        </div>
<?php } ?><?php 
...
// PUG_DEBUG:23
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](['type' => 'password'], ['name' => 'old_password'], ['class' => 'mt-4 font-semibold'], ['placeholder' => 'Eski şifre giriniz.'], ['required' => true], array(  ))) ? var_export($_pug_temp, true) : $_pug_temp) ?> /></div>
<?php 
...
// PUG_DEBUG:27
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](['type' => 'password'], ['name' => 'new_password'], ['class' => 'mt-4 font-semibold'], ['placeholder' => 'Yeni şifre giriniz.'], ['required' => true], array(  ))) ? var_export($_pug_temp, true) : $_pug_temp) ?> />        </div>
<?php 
...
// PUG_DEBUG:31
 ?><input<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](['type' => 'password'], ['name' => 'new_password_again'], ['class' => 'mt-4 font-semibold'], ['placeholder' => 'Yeni şifre tekrar giriniz.'], ['required' => true], array(  ))) ? var_export($_pug_temp, true) : $_pug_temp) ?> />        </div>
<?php 
...
// PUG_DEBUG:36
 ?><a<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](['href' => '/users/dashboard'], array(  ))) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
