...
// PUG_DEBUG:34
 ?>    <form<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](['action' => 'users/login'], ['method' => 'POST'], array(  ))) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
...
// PUG_DEBUG:32
 ?><a<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](['class' => 'button-register mt-4'], ['href' => '/register'], array(  ))) ? var_export($_pug_temp, true) : $_pug_temp) ?>><?php 
